...
PasswordResetApiView, PasswordSetApiView, UserUpdateAPIView, CreateStaffUserAPIView, UserRetrieveAPIView, UserStatusView, \
UserOrganizations
...
urlpatterns = [
     ...
     path(r'<int:organization_pk>/user-status/', UserStatusView.as_view(), name='user-status'),
     path(r'organizations/', UserOrganizations.as_view(), name='user-organizations')
]